...
//====================== XMLParser Class =============================
// Description:
//		Parser class used to use XML files more easier 
...
private:
	...
	//private main node_test function, will execute one of the 3 test functions
	...
	//second test, testing not only on the node's name, but also on an attributes value
...
//public non-member function to convert a tstring to a char array c string.
...
//public non-member template function to change an attributes name
